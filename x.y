...
VARIABLE_DECLARATION	: TYPE DECLARATION_LIST ';'NEWLINE
						| DECLARATION_LIST ';' NEWLINE
						;
...
FUNCTION_CALL			:	ID '(' PASS_PARAMETER ')' ';' NEWLINE;
